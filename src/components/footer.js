  ...
  <div className="footer gradient inverse section">
    ...
    <div className="container text-center">
      <div className="row nav-row">
        <div className="col-4">
          <ul>
            <li>
              <Link To="/products" id="cta-footer-products">
                Products
              </Link>
            </li>
            <li>
              <Link To="/pricing" id="cta-footer-pricing">
                Pricing
              </Link>
            </li>
            <li>
              <Link To="/docs" id="cta-footer-docs">
                Docs
              </Link>
            </li>
            <li>
              <Link To="/blog" id="cta-footer-blog">
                Blog
              </Link>
            </li>
          </ul>
    ...
    <nav class={"modal " + props.modalClass}>
      <section className="mobile-menu-modal">
        ...
        <ul class="">
          <li>
            <a href="/" id="cta-mainNav-home-mobile">
              Home
            </a>
          </li>
          <li>
            <a href="/products" id="cta-mainNav-features-mobile">
              Products
            </a>
          </li>
          <li>
            <a href="/pricing" id="cta-mainNav-pricing-mobile">
              Pricing
            </a>
          </li>
          <li>
            <a href="/docs" id="cta-mainNav-docs-mobile">
              Docs
            </a>
          </li>
          <li>
            <a href="/blog" id="cta-mainNav-blog-mobile">
              Blog
            </a>
          </li>
          <li>
            <a href="/enterprise" id="cta-mainNav-login-mobile">
              Contact sales
            </a>
          </li>
          <li>
